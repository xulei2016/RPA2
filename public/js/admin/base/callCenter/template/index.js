        ...
        var param = {
            ...
            columns: [{
                ...
                formatter: function(value, row, index){
                    var id = value;
                    var result = "";
                    result += " <a href='javascript:;' class='btn btn-xs btn-primary' onclick=\"operation($(this));\" url='/admin/sys_call_center_template/"+id+"/edit' title='编辑'><span class='glyphicon glyphicon-pencil'></span></a>";
