$(function(){
    let url_prefix = '/admin/sys_call_center_manager/';
    let selectInfo = [];
    /*
     * 初始化
     */
    ...
    function getSearchGroup(){
        //特殊格式的条件处理
        var temp = {
            nickname : $("#pjax-container #search-group #nickname").val(),
            work_number : $("#pjax-container #search-group #work_number").val()
        };
        return temp;
    }
        ...
        var param = {
            ...
            columns: [{
                ...
                formatter: function(value, row, index){
                    var id = value;
                    var result = "";
                    result += " <a href='javascript:;' class='btn btn-xs btn-primary' onclick=\"operation($(this));\" url='"+url_prefix + id+"/edit' title='编辑'><span class='glyphicon glyphicon-pencil'></span></a>";
