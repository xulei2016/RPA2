        ...
        var param = {
            ...
            columns: [{
                    ...
                    formatter: function(value, row, index){
                        var id = value;
                        var result = "";
                        result += " <a href='javascript:;' class='btn btn-xs btn-warning' onclick=\"operation($(this));\" url='/admin/rpa_discredit/immedtasks/"+id+"' title='添加立即任务'><span class='glyphicon glyphicon-plus'></span></a>";
                        result += " <a href='javascript:;' class='btn btn-xs btn-info' onclick=\"operation($(this));\" url='/admin/rpa_discredit/"+id+"' title='查看参数'><span class='glyphicon glyphicon-search'></span></a>";
                        result += " <a href='javascript:;' class='btn btn-xs btn-primary' onclick=\"operation($(this));\" url='/admin/rpa_discredit/"+id+"/edit' title='编辑'><span class='glyphicon glyphicon-pencil'></span></a>";
