$(function(){
    ...
    function bindEvent(){
        ...
        //任务类型
        $(modal+' form input#type').bootstrapSwitch({"onColor":"lightseagreen","offColor":"danger",'onText':"一次性任务",'offText':"循环任务","state":false,onSwitchChange:function(e,state){
            if(!state){
        ...
        //执行时间类型
        $(modal+' form input#implement_type').bootstrapSwitch({"onColor":"lightseagreen","offColor":"info",'onText':"自定义",'offText':"分割时间段","state":false,onSwitchChange:function(e,state){
            if(!state){
    ...
    //提交信息的表单配置
    var FormOptions={
        url:'/admin/rpa_jjr_distribution',
