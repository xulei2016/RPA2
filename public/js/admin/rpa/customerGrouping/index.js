        ...
        var param = {
            ...
            columns: [{
                    ...
                    formatter: function(value, row, index){
                        var id = value;
                        var result = "";
                        result += " <a href='javascript:;' class='btn btn-sm btn-success' onclick=\"operation($(this));\" url='/admin/rpa_customerGrouping/immedtasks/"+id+"' title='立即执行'>立即执行</a>";
                        result += " <a href='javascript:;' class='btn btn-sm btn-info' onclick=\"operation($(this));\" url='/admin/rpa_customerGrouping/"+id+"' title='查看参数'>查看</a>";
                        result += " <a href='javascript:;' class='btn btn-sm btn-primary' onclick=\"operation($(this));\" url='/admin/rpa_customerGrouping/"+id+"/edit' title='编辑'>编辑</a>";
