$(function(){
    let url_prefix = '/admin/rpa_contract_receiver/';
    ...
    function testEmail(id){
        swal({
            ...
            if (isConfirm.value) {
                $.ajax({
                    url:'/admin/rpa_download_receiver/email',
                    type:'post',
                    dataType:'json',
                    data:{id:id},
                    success:function(r){
        ...
        var param = {
            ...
            columns: [{
                ...
                events: {
                    ...
                    "click #testEmail":function (e, value, row, index){
                        var id = row.id;
                        testEmail(id);
                    },
                },
                formatter: function(value, row, index){
                    ...
                    // result += " <a href='javascript:;' class='btn btn-sm btn-success' id='testEmail' title='邮件测试'>邮件测试</a>";
                    return result;
                }
            }]
        };
