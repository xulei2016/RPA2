            ...
            },
                {
                    ...
                    formatter: function(value, row, index){
                        ...
                        if(row.check_status == 0 || row.check_status == 3) {
                            result += "<a href='javascript:;' class='btn btn-sm btn-primary' onclick=\"operation($(this));\" url='/admin/rpa_new_monitor_picture/"+id+"/edit' title='审核'>审核</a>";
                        } else if(row.check_status == 1) {
                            result += "<a href='javascript:;' class='btn btn-sm btn-primary' onclick=\"operation($(this));\" url='/admin/rpa_new_monitor_picture/"+id+"/review' title='复核'>复核</a>";
                        } else {
                            result += "<a href='javascript:;' class='btn btn-sm btn-primary' onclick=\"operation($(this));\" url='/admin/rpa_new_monitor_picture/"+id+"' title='查看'>查看</a>";
                        }
