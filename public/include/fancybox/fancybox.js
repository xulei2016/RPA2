...
(function (window, document, $, undefined) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    rotateL : function(){
      ...
      self.rad = (self.rad-90)%360;
      img.css({transform:'rotate('+self.rad+'deg)'});
    },
    ...
    addEvents: function () {
      ...
      self.$refs.container
        ...
        .on("click.fb", "[data-fancybox-left]", function (e) { //  左旋转
            // Click handler for zoom button
            self.rotateL();
        })
        .on("click.fb", "[data-fancybox-right]", function (e) { //  右旋转
          // Click handler for zoom button
          self.rotateR();
        })
      ;
