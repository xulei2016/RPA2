...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function() {
        ...
        if(this.options.paginationShowPageGo){
            ...
            // 渲染跳转到指定页的元素
            html.push(
                '<ul class="pagination-jump float-left">',
                '<li class=""><span>' + this.options.pageGo() + ' </span></li>',
                '<li class=""><input type="text" class="page-input" value="' + this.options.pageNumber + '"   /></li>',
                '<li class="page-go"><a class="jump-go btn btn-default" href="javascript:;">GO</a></li>',
                '</ul>');

            // 放到原先的分页组件后面
            this.$pagination.find('.pagination-detail').after(html.join(''));
            // 点击按钮触发跳转到指定页函数
