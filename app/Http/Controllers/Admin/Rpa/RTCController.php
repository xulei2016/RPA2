 ...
 * @author hsu lay
 */
class RTCController extends BaseAdminController
{
    //task name
    private $task_name;
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "客户开户视频收集 任务列表");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 客户开户视频收集 参数");
        return view('admin.rpa.RTC.show', ['info' => $info]);
    }
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 客户开户视频收集 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function immedtasks(Request $request){
        ...
        return view('admin/rpa/RTC/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
