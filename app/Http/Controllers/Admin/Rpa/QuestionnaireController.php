...
class QuestionnaireController extends BaseAdminController
{
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "问卷录入 任务列表");
        return view('admin.rpa.Questionnaire.index');
    }
    ...
    {
        return view('admin.rpa.Questionnaire.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "添加 问卷录入 任务");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 问卷录入 参数");
        return view('admin.rpa.Questionnaire.show', ['info' => $info]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 问卷录入 参数");
        return view('admin.rpa.Questionnaire.edit', ['info' => $info]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //发布任务
        $this->immedtask($data['name']);
        $this->log(__CLASS__, __FUNCTION__, $request, "修改 问卷录入 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 问卷录入 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function immedtasks(Request $request){
        $this->log(__CLASS__, __FUNCTION__, $request, "立即发布 问卷录入 页");
        $jsondata = "";
        if($request->id){
            $res = rpa_releasetasks::find($request->id);
            $jsondata = json_decode($res->jsondata,true);
        }
        return view('admin/rpa/Questionnaire/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
