...
/**
 * investorPWDController
 * @author hsu lay
 */
class InvestorPWDController extends BaseAdminController
{
    //task name
    private $task_name;
    ...
    {
        $this->task_name = 'InvestorPassword';
    }
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "投资者密码 任务列表");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 投资者密码 参数");
        return view('admin.rpa.investorPWD.show', ['info' => $info]);
    }
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 投资者密码 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function pagenation(Request $request){
        $rows = $request->rows;
        $conditions = [['name','=','InvestorPassword']];
    ...
    public function immedtasks(Request $request){
        ...
        return view('admin/rpa/investorPWD/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
