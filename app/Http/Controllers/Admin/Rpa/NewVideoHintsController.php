...
/**
 * NewVideoHintsController
 * @author hsu lay
 */
class NewVideoHintsController extends BaseAdminController
{
    //task name
    private $task_name;
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "FTP新增视频提醒 任务列表");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 FTP新增视频提醒 参数");
        return view('admin.rpa.NewVideoHints.show', ['info' => $info]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $info['data'] = explode(",",$info['data']['date']);
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 FTP新增视频提醒 参数");
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 FTP新增视频提醒 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function immedtasks(Request $request){
        ...
        if($request->id){
            ...
            $jsondata = explode(",",$jsondata['date']);
        }
        return view('admin/rpa/NewVideoHints/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
