...
class RpaController extends BaseAdminController
{
    ...
    {
        $data = $this->get_params($request, ['name','filepath','failtimes','timeout','PaS',['isfp',0],'bewrite','notice_type','noticeAccepter'], false);
    ...
    {
        $data = $this->get_params($request, ['name','filepath','failtimes','timeout','PaS',['isfp',0],'bewrite','notice_type','noticeAccepter']);
        if(isset($data['noticeAccepter'])){
            $data['noticeAccepter'] = implode(',', $data['noticeAccepter']);
        }
