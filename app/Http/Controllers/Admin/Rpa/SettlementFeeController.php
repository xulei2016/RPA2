...
/**
 * SettlementFeeController
 * @author hsu lay
 */
class SettlementFeeController extends BaseAdminController
{
    //task name
    private $task_name;
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "官网手续费 任务列表");
        return view('admin.rpa.SettlementFee.index');
    }
    ...
    {
        return view('admin.rpa.SettlementFee.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "添加 官网手续费 任务");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 官网手续费 参数");
        return view('admin.rpa.SettlementFee.show', ['info' => $info]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $info['data'] = isset($info['jsondata']) ? json_decode($info['jsondata'], true) :'';
        $info['data'] = $info['data']['model_kind'];
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 官网手续费 参数");
        return view('admin.rpa.SettlementFee.edit', ['info' => $info]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //发布任务
        $this->immedtask($data['name']);
        $this->log(__CLASS__, __FUNCTION__, $request, "修改 官网手续费 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 官网手续费 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function immedtasks(Request $request){
        $this->log(__CLASS__, __FUNCTION__, $request, "立即发布 官网手续费 页");
        $jsondata = "";
        if($request->id){
            $res = rpa_releasetasks::find($request->id);
            $jsondata = json_decode($res->jsondata,true);
        }
        return view('admin/rpa/SettlementFee/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
