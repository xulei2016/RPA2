...
/**
 * Class ProfessionChangeTaskController
 * @package App\Http\Controllers\Admin\Rpa
 */
class ProfessionChangeController extends BaseAdminController
{
    ...
    {
        $this->task_name = 'ProfessionChangeTask';
    }
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 职业变更 任务列表");
        return view('admin.rpa.profession.index');
    }
    ...
    {
        return view('admin.rpa.profession.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "添加 职业变更 任务");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 职业变更 参数");
        return view('admin.rpa.profession.show', ['info' => $info]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 职业变更 参数");
        return view('admin.rpa.profession.edit', ['info' => $info]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //发布任务
        $this->immedtask($data['name']);
        $this->log(__CLASS__, __FUNCTION__, $request, "修改 职业变更 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 职业变更 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function pagenation(Request $request){
        $rows = $request->rows;
        $conditions = [['name','=','ProfessionChangeTask']];
    ...
    public function immedtasks(Request $request){
        $this->log(__CLASS__, __FUNCTION__, $request, "立即发布 职业变更 页");
        $jsondata = "";
        if($request->id){
            $res = rpa_releasetasks::find($request->id);
            $jsondata = json_decode($res->jsondata,true);
        }
        return view('admin/rpa/profession/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
    public function insertImmedtasks(Request $request){
        ...
        $task['name'] = 'ProfessionChangeTask';
