 ...
 * @author hsu lay
 */
class downloadPDFController extends BaseAdminController
{
    //task name
    private $task_name;
    ...
    {
        $this->log(__CLASS__, __FUNCTION__, $request, "客户PDF下载 任务列表");
        return view('admin.rpa.downloadPDF.index');
    }
    ...
    {
        return view('admin.rpa.downloadPDF.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "添加 客户PDF下载 任务");
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 客户PDF下载 参数");
        return view('admin.rpa.downloadPDF.show', ['info' => $info]);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 客户PDF下载 参数");
        return view('admin.rpa.downloadPDF.edit', ['info' => $info]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //发布任务
        $this->immedtask($data['name']);
        $this->log(__CLASS__, __FUNCTION__, $request, "修改 客户PDF下载 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function destroy(Request $request, $ids)
    {
        ...
        $this->log(__CLASS__, __FUNCTION__, $request, "删除 客户PDF下载 任务");
        return $this->ajax_return(200, '操作成功！');
    }
    ...
    public function immedtasks(Request $request){
        $this->log(__CLASS__, __FUNCTION__, $request, "立即发布 客户PDF下载 页");
        $jsondata = "";
        if($request->id){
            $res = rpa_releasetasks::find($request->id);
            $jsondata = json_decode($res->jsondata,true);
        }
        return view('admin/rpa/downloadPDF/add_immed',['jsondata'=>$jsondata]);
    }
    /**
     * 发布立即任务
     */
