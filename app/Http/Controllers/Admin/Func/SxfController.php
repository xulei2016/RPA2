...
class SxfController extends BaseAdminController
{
    private $table = 'TGSPZSXF';
    ...
    public function index(Request $request){
        $this->log(__CLASS__, __FUNCTION__, $request, "查看 手续费标准 页");
        return view('admin/func/Sxf/index');
    }
    ...
    public function pagination(Request $request)
    {
        ...
        $hypz = $request->get('hypz', null); // 合约品种
        $table = $request->get('type', 'TGSPZSXF'); // 表名
        if(!$table) $table = 'TGSPZSXF';
        $this->table = $table;
