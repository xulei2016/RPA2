                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header">
                                        <a href="#">{{$v['created_by']}}</a> @if($v['type'] == 3)
                                            紧急维护 @elseif($v['type'] == 2) 版本升级
                                        @else 正常更新 @endif
                                    </h3>
                                    ...
                                    <div class="timeline-footer">
                                        <a url="/admin/sys_version_update/{{$v['id']}}" class="btn btn-primary btn-sm"
                                           onclick="operation($(this))">查看详细</a> {{-- <a href="javascript:;" class="btn btn-danger btn-sm">Delete</a>--}}
                                    </div>
                                </div>
                            </div>
                    @endforeach
