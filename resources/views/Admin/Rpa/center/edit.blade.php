@component('admin.widgets.editForm')    
    @slot('formContent')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="PaS" class="form-control" id="PaS">
                    <option value="" @if('' == $info->PaS) selected @endif>全部</option>
                    ...
                    <option value="主虚拟机" @if('主虚拟机' == $info->PaS) selected @endif>主虚拟机</option>
                    <option value="从虚拟机" @if('从虚拟机' == $info->PaS) selected @endif>从虚拟机</option>
                </select>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row  @if(0 == $info->notice_type || 4 == $info->notice_type) hidden @endif accepter">
