...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="name" id="name" value="VideoAllot" placeholder="任务名称" required disabled>
    </div>
</div>
<div class="form-group ">
...
@slot('formScript')
<script src="{{URL::asset('/js/admin/rpa/RTC/add_immed.js')}}"></script>
@endslot
@endcomponent