    ...
    <div class="container-fluid">
        <div class="row">
            ...
            @component('admin.widgets.toolbar', ['operation_show' => false])
                ...
                @endslot
                @slot('operation')
                    <a class="btn btn-success btn-sm" url="/admin/rpa_SettlementFee/immedtasks" title="新增" onclick="operation($(this));">
                        <span class="glyphicon glyphicon-plus"></span><span class="hidden-xs">&nbsp;立即任务</span>
                    </a>
                    <a class="btn btn-success btn-sm" url="/admin/rpa_SettlementFee/create" title="新增" onclick="operation($(this));">
...
<script src="{{URL::asset('/js/admin/rpa/SettlementFee/index.js')}}"></script>
@endsection