@component('admin.widgets.addForm')    
        ...
        <div class="form-group ">
            ...
            <div class="col-sm-10">
                <div class="target_web">
                    <div class="row">
                        <div class="col-xs-12">
                            <label><input type="radio" name="jsondate" value="8200" @if($info->data == '8200')checked @endif> 8200</label>
                            <label><input type="radio" name="jsondate" value="8300" @if($info->data == '8300')checked @endif> 8300</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @slot('formScript')
        <script src="{{URL::asset('/js/admin/rpa/SettlementFee/edit.js')}}"></script>
    @endslot
@endcomponent