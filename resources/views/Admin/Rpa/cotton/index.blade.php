    ...
    <div class="panel box box-primary">
        <div class="box-body">
            ...
            @component('admin.widgets.toolbar', ['operation_show' => false])
                @slot('listsOperation')
                    @if(auth()->guard('admin')->user()->can('rpa_cotton'))
                ...
                @endslot
                @slot('operation')
                    <a class="btn btn-danger btn-sm importExcel" url="/admin/rpa_cotton/importExcel" title="批量导入" onclick="operation($(this));">
...
<script src="{{URL::asset('/js/admin/rpa/cotton/index.js')}}"></script>
@endsection