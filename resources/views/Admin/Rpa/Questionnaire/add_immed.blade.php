...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="name" id="name" value="sdxTestWirte" placeholder="任务名称" required disabled>
    </div>
</div>
<div class="form-group row ">
...
@slot('formScript')
<script src="{{URL::asset('/js/admin/rpa/Questionnaire/add_immed.js')}}"></script>
@endslot
@endcomponent