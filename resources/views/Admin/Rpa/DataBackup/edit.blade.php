@component('admin.widgets.addForm')    
    ...
    <div class="form-group row">
            ...
            <div class="col-sm-10">
                <label><input type="radio" name="name" value="BakNASFiles" @if($info->name == 'BakNASFiles') checked @endif> 开户资料</label>
                <label><input type="radio" name="name" value="BakNASFiles_sdx" @if($info->name == 'BakNASFiles_sdx') checked @endif> 适当性资料</label>
            </div>
        </div>
        <div class="form-group row">
    ...
    @slot('formScript')
        <script src="{{URL::asset('/js/admin/rpa/DataBackup/edit.js')}}"></script>
    @endslot
@endcomponent