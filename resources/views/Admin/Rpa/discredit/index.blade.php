                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        @component('admin.widgets.toolbar', ['operation_show' => false])
                            ...
                            @endslot
                            @slot('operation')
                                <a class="btn btn-success btn-sm" url="/admin/rpa_discredit/immedtasks" title="新增" onclick="operation($(this));">
                                    <span class="glyphicon glyphicon-plus"></span><span class="hidden-xs">&nbsp;立即任务</span>
                                </a>
                                <a class="btn btn-success btn-sm" url="/admin/rpa_discredit/create" title="新增" onclick="operation($(this));">
...
<script src="{{URL::asset('/js/admin/rpa/discredit/index.js')}}"></script>
@endsection