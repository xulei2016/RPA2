...
@section('content')
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        @component('admin.widgets.search-group')
                            @slot('searchContent')
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="user" placeholder="资金账户或客户姓名">
                                    <input style="display: none;" type="text" class="form-control" id="user" placeholder="资金账户或客户姓名">
                                </div>
    ...
    <script src="{{URL::asset('/js/admin/func/SeatApply/index.js')}}"></script>
@endsection