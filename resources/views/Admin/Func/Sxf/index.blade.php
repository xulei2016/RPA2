...
@section('content')
                            ...
                            @slot('searchContent')
                                ...
                                <div class="col-sm-2">
                                    <select name="type" id="type" class="form-control">
                                        ...
                                        <option value="TGSPZSXF">公司</option>
                                        <option value="TJYSPZSXF">交易所</option>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="hypz" placeholder="合约品种">
                                </div>
                            @endslot
                        @endcomponent
    ...
    <script src="{{URL::asset('/js/admin/func/Sxf/index.js')}}"></script>
@endsection