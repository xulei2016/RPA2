@component('admin.widgets.editForm')   
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10" data-fancybox href="/admin/rpa_monitor_picture/showImg?url={{ $sfz_zm }}">
            <img src="/admin/rpa_monitor_picture/showImg?url={{ $sfz_zm }}" alt="身份证正面" width="100%" />
        </div>
    </div>

    <div class="form-group row">
        <label for="name" class="col-sm-2 control-label">身份证反面</label>
        <div class="col-sm-10" data-fancybox href="/admin/rpa_monitor_picture/showImg?url={{ $sfz_fm }}">
            <img src="/admin/rpa_monitor_picture/showImg?url={{ $sfz_fm }}" alt="身份证反面" width="100%" />
        </div>
    </div>
    ...
    @slot('formScript')
        <script src="{{URL::asset('/js/admin/Func/MonitorPicture/review.js')}}"></script>
    @endslot
@endcomponent