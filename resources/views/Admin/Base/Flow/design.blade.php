...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('/css/admin/flow/flowDesign.css')}}"> {{-- contentMenu --}}
...
<body>
        ...
        <div class="navbar-inner">
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        <li>
                            <a href="javascript:history.go(-1)">工作流</a>
                        </li>
                        <li>
                            <a href="javascript:;">正在设计【{{$flow->title}}流程】</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container mini-layout" id="flowdesign_canvas">
        <!--div class="node-node btn" style="left: 189px; top: 340px;"><span class="node-num badge badge-inverse"><i class="icon-star icon-white"></i>3</span> 步骤3</div-->
    </div>
    <!-- /container -->
    ...
    <script src="{{URL::asset('/include/jquery-ui/jquery-ui-1.9.2-min.js')}}"></script> {{-- contentMenu --}}
    ...
    <!-- jsPlumb -->
    {{--
    <script src="{{URL::asset('/include/jquery-jsPlumb/jsPlubm-1.7.2.js')}}"></script> --}}
        ...
        var _canvas = $("#flowdesign_canvas").Flowdesign({
            ...
            , canvasMenus: {
                ...
                "save": function (t) {
                    ...
                    $.post(url, { "flow_id": id, "node_info": nodeInfo }, function (data) {
                        mAlert(data.msg);
                    }, 'json');
                },
                //刷新
            ...
            , nodeMenus: {
                ...
                "begin": function (t) {
                    ...
                    // $.post('/node/begin',{"flow_id":id,"node_id":activeId},function(data){
                    //     layer.msg('设置成功');
                    // },'json');
                    var nodeInfo = _canvas.getNodeInfo();//连接信息
                ...
                "attribute": function (t) {
                    ...
                    ajaxModal('/admin/node/attribute?id=' + activeId, function () {
                        //alert('加载完成执行')
                    });
