...
<html>
 <head>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <!--select 2-->
    <link rel="stylesheet" href="{{URL::asset('/include/jquery-multisect2side/multiselect2side.css')}}" media="screen">
 </head>
<body>
...
<!--div class="process-process btn" style="left: 189px; top: 340px;"><span class="process-num badge badge-inverse"><i class="icon-star icon-white"></i>3</span> 步骤3</div-->
 ...
 {{-- contentMenu --}}
 <script src="{{URL::asset('/include/jquery-contentMenu/jquery.contextMenu.js')}}"></script>
