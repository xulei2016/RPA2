                ...
                <div class="card card-primary card-outline">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link active" href="#fa-icons" data-toggle="tab">Font Awesome</a></li>
                            <li class="nav-item"><a class="nav-link" href="#glyphicons" data-toggle="tab">Glyphicons</a></li>
                        </ul>
