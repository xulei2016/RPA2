...
{{--                                <li><a class="dropdown-item" href="javascript:void(0)" id="export">导出选中</a></li>--}}
                            ...
                            @slot('operation')
                                    <a href="javascript:;"  class="btn btn-primary btn-sm" onclick="operation($(this))" url="/admin/rpa_offline_credit/create?type=person">查询个人</a>
                                    <a href="javascript:;"  class="btn btn-primary btn-sm" onclick="operation($(this))" url="/admin/rpa_offline_credit/create?type=company">查询企业</a>
                            @endslot
                        @endcomponent
    ...
    <script src="{{URL::asset('/js/admin/Auxiliary/offlineCredit/index.js')}}"></script>
@endsection
