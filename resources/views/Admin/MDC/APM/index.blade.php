...
@section('content')
            ...
            <div class="row" style="width: 100%; margin: 0;">
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <canvas id="m01" style="display: block;"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <canvas id="m02" style="display: block;"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <canvas id="s01" style="display: block;"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <canvas id="s02" style="display: block;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{URL::asset('/js/admin/MDC/APM/index.js')}}"></script>
@endsection